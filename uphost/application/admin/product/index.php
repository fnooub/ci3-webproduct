                                        ...
                                        foreach ($catalog as $row):
                                            ...
                                            <optgroup label="<?php echo $row->name; ?>">
                                                ...
                                                foreach ($row->subs as $sub):
                                                    ?>
                                                    <option <?php echo ($this->input->get('catalog') == $sub->id)? 'selected':''; ?>
                                            ...
                                            <?php else: ?>
                                                <option <?php echo ($this->input->get('catalog') == $row->id)? 'selected':''; ?>
                ...
                <tr class="row_<?php echo $row->id; ?>">
                    ...
                    <td class="textR">
                        <?php if ($row->discount > 0): ?>
                            ...
                            echo '<b style="color:red">' . number_format($price_new) . '</b>';
                            ?>

                            <p style="text-decoration:line-through"><?php echo number_format($row->price); ?></p>
                        <?php else: ?>
                            <?php
                            echo '<b style="color:red">' . number_format($row->price) . '</b>';
                            ?>
                        <?php endif; ?>
                    ...
                    <td class="option textC">
                        ...
                        <a href="<?php echo admin_url('product/edit/'.$row->id); ?>" target="_blank" class="tipS" title="Xem chi tiết sản phẩm">
