                ...
                <div class="tab_container">
                    <div id="tab1" class="tab_content pd0">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="name" value="<?php echo $product->name; ?>"
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                    ...
                                    <?php if($image_list)foreach ($image_list as $img): ?>

                                        <img src="<?php echo base_url('upload/product/' . $img); ?>"
                                             style="width:100px; height:75px; margin:5px; ">
                                    <?php endforeach; ?>
                                </div>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
		<span class="oneTwo">
			<input name="price" value="<?php echo $product->price; ?>" style="width:100px" id="param_price"
                   class="format_number" _autocheck="true"
                   type="text">
			<img class="tipS" title="Giá bán sử dụng để giao dịch" style="margin-bottom:-8px"
                 src="<?php echo public_url('admin'); ?>/crown/images/icons/notifications/information.png">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
		<span>
			<input name="discount" value="<?php echo $product->discount; ?>" style="width:100px" id="param_discount"
                   class="format_number" type="text">
			<img class="tipS" title="Số % giảm giá" style="margin-bottom:-8px"
                 src="<?php echo public_url('admin'); ?>/crown/images/icons/notifications/information.png">
		</span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                    ...
                                    foreach ($catalog as $row):
                                            ...
                                            <optgroup label="<?php echo $row->name; ?>">
                                                ...
                                                foreach ($row->subs as $sub):
                                                    ...
                                                    <option value="<?php echo $sub->id; ?>"
                                                        <?php echo ($sub->id == $product->catalog_id) ? 'selected' : '' ?>>
                                                        <?php
                                                        echo $sub->name;
                                                        ?>
                                                    </option>
                                        ...
                                        <?php else: ?>
                                            <option value="<?php echo $row->id; ?>"
                                                <?php echo ($row->id == $product->catalog_id) ? 'selected' : '' ?>> <?php echo $row->name; ?></option>
                                            <?php
                                        endif;
                                    endforeach;
                                    ?>
                                ...
                                <div name="catalog_error" class="clear error"></div>
                            </div>
                            <div class="clear"></div>
                        </div>
                    ...
                    <div id="tab2" class="tab_content pd0">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><textarea name="site_title" id="param_site_title" _autocheck="true"
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><textarea name="meta_desc" id="param_meta_desc" _autocheck="true"
                                                               rows="4" cols=""></textarea></span>
