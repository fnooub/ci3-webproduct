                    ...
                    <form class="list_filter form" action="<?php echo admin_url('news'); ?>" method="get">
                        <table width="80%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="label" style="width:40px;"><label for="filter_id">Tieu de</label></td>
                ...
                <td colspan="6">
                    <div class="list_action itemActions">
                        <a href="#submit" id="submit" class="button blueB"
                           url="<?php echo admin_url('news/del_all'); ?>">
            ...
            <?php foreach ($list as $row): ?>
                <tr class="row_<?php echo $row->id; ?>">
                    ...
                    <td class="option textC">
                        ...
                        <a href="<?php echo admin_url('news/edit/' . $row->id); ?>" target="_blank" class="tipS"
                           title="Xem chi tiết bai viet">
                        ...
                        <a href="<?php echo admin_url('news/del/' . $row->id); ?>" title="Xóa"
