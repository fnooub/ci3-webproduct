                ...
                <td colspan="6">
                    <div class="list_action itemActions">
                        <a href="#submit" id="submit" class="button blueB"
                           url="<?php echo admin_url('slide/del_all'); ?>">
            ...
            <?php foreach ($list as $row): ?>
                <tr class="row_<?php echo $row->id; ?>">
                    ...
                    <td class="option textC">
                        ...
                        <a href="<?php echo $row->link; ?>" target="_blank" class="tipS"
                           title="Xem chi tiết link slide">
                        ...
                        <a href="<?php echo admin_url('slide/del/' . $row->id); ?>" title="Xóa"
