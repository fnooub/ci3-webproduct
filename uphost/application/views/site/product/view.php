        ...
        <div class='product_view_content'>
            ...
            <p class='option'>
                ...
                <?php if ($product->discount > 0): ?>
                    ...
                    echo "<span class='product_price'>" . number_format($price_new) . "</span>";
                    echo '<span class="price_old">' . number_format($product->price) . '</span>'
                    ?>
                <?php else:
                    echo "<span class='product_price'>" . number_format($product->price) . "</span>";
                    ?>
...
<div class="usual" id="usual1">
    <ul>
        <li><a title="Chi tiết sản phẩm" rel='tab2' href='javascript:void(0)' class="tab selected">Chi tiết sản phẩm</a>
        </li>
...
<div class="usual-content">
    <div id="tab2" style="display: block;">
        ...
        <center>
            <div id="fb-root"></div>
            <script src="https://developers.facebook.com/docs/plugins/comments#configurator"></script>
            <div class="fb-comments" data-href="<?php echo current_url(); ?>"
                 data-num-posts="5" data-width="550" data-colorscheme="light" data-order-by="reverse_time"></div>
        </center>
    </div>
