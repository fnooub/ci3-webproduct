...
<link rel="stylesheet"
      href="<?php echo public_url('site'); ?>/js/jquery/autocomplete/css/smoothness/jquery-ui-1.8.16.custom.css"
      type="text/css">
<script src="<?php echo public_url('site'); ?>/js/jquery/autocomplete/jquery-ui-1.8.16.custom.min.js"
    ...
    <div id="search"><!-- the search -->
        <form action="<?php echo site_url('product/search'); ?>" method="get">
            <input type="text" aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off"
                   class="ui-autocomplete-input" placeholder="Tìm kiếm sản phẩm..." value="" name="key-search"
                   id="text-search">
...
<div id="menu"><!-- the menu -->
    <ul class="menu_top">
        ...
        <?php if(isset($user_info)): ?>
            <li class=""><a href="<?php echo site_url('user') ?>">Hi, <?php echo $user_info->name; ?></a></li>
            <li class=""><a href="<?php echo site_url('user/logout'); ?>">Thoat</a></li>
        <?php else: ?>
