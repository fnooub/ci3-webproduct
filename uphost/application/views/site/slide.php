...
<link type="text/css" href="<?php echo public_url('site'); ?>/royalslider/skins/minimal-white/rs-minimal-white.css"
      rel="stylesheet">
        ...
        <div id="HomeSlide" class="royalSlider rsMinW">
            <?php foreach ($slide_list as $row): ?>
                <a href="<?php echo $row->link; ?>" target='_blank'>
                    <img src="<?php echo base_url('upload/slide/' . $row->image_link); ?>"
                         atl="<?php echo $row->name; ?>"/>
                </a>
            <?php endforeach; ?>
        </div>
    </div>
