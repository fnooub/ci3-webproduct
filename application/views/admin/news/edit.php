            ...
            <div class="widget">
                ...
                <div class="tab_container">
                    <div id="tab1" class="tab_content pd0">
                        <div class="formRow">
                            <label class="formLeft" for="param_title">Tieu de:<span class="req">*</span></label>
                            <div class="formRight">
                                <span class="oneTwo"><input name="title" value="<?php echo $news->title; ?>"
                                                            id="param_title" _autocheck="true"
                                                            type="text"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                    ...
                                    <img src="<?php echo base_url('upload/news/' . $news->image_link); ?>"
