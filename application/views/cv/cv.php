...
<head>
    ...
    <link href="<?php echo public_url('cv'); ?>/css/style.css" rel="stylesheet" type="text/css"/>
    <link rel="icon" href="<?php echo public_url('cv'); ?>/image/favicon.ico" type="image/x-icon">
</head>
<body>
<script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/jquery-ui-1.10.2.custom.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/detect-browser-device.js"></script>
<noscript>
    <div id="javascript-banner-container">
        <div id="javascript-banner">
            ...
            <div id="javascript-banner-middle">
                <div id="javascript-banner-text-a">VUI LÒNG BẬT</div>
...
<div id="music" style="display: none">
    <audio controls autoplay loop>
        <source src="<?php echo public_url('cv'); ?>/audio/mario.mp3" type="audio/mpeg">
    </audio>
</div>

    <div id="preloader" class="displaynone">
        <script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/preloader-transparent-or-displaynone.js"></script>
    ...
    <script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/preloader.js"></script>
    ...
    <div id="container" class="displaynone">
        <script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/container-transparent-or-displaynone.js"></script>
        ...
        <div id="layer-horizontal-3" class="layer-horizontal">
            ...
            <div id="plants-container">
                ...
                <div id="plant-ribbon-container">
                    ...
                    <div id="plant-ribbon-2" class="plant-ribbon">
                        <div class="plant-ribbon-left"></div>
                        <div class="plant-ribbon-middle">LEARN</div>
                        <div class="plant-ribbon-right"></div>
                    </div>
                    ...
                    <div id="plant-ribbon-4" class="plant-ribbon">
                        <div class="plant-ribbon-left"></div>
                        <div class="plant-ribbon-middle">ALGORITHM</div>
                        <div class="plant-ribbon-right"></div>
                    </div>
                </div>
                ...
                <div class="ribbon-container">
                    <div class="ribbon-relative">
                        ...
                        <div class="ribbon-middle">Multidisciplinary Program</div>
            ...
            <div id="nba-container">
                ...
                <div id="nba-board-3" class="nba-board-blue">
                    <div class="nba-text-container">
                        <div class="nba-text">R</div>
                    </div>
                </div>
                <div id="nba-board-4" class="nba-board-red">
                    <div class="nba-text-container">
                        <div class="nba-text">C</div>
                    </div>
                </div>
                ...
                <div class="ribbon-container">
                    <div class="ribbon-relative">
                        <div class="ribbon-left"></div>
                        <div class="ribbon-middle">Football</div>
                        <div class="ribbon-right"></div>
                    </div>
                </div>
            </div>
            ...
            <div id="buildings-container">
                ...
                <div class="ribbon-container">
                    <div class="ribbon-relative">
                        <div class="ribbon-left"></div>
                        <div class="ribbon-middle">Sống và học tập ở TP HCM</div>
                        <div class="ribbon-right"></div>
                    </div>
                </div>
            </div>
            ...
            <div id="splash-container">
                <div id="scroll-or-swipe-text-container-1" class="scroll-or-swipe-text-container">NHẤN PHÍM CÁCH HOẶC
                    CUỘN CHUỘT
                </div>
                <div id="scroll-or-swipe-text-container-2" class="scroll-or-swipe-text-container">THATWEB3.ESY.ES</div>
                ...
                <div class="ribbon-container">
                    <div class="ribbon-relative">
                        <div class="ribbon-left"></div>
                        <div class="ribbon-middle">THATWEB3.ESY.ES</div>
                        <div class="ribbon-right"></div>
                    </div>
                </div>
            </div>
                ...
                <div id="skill-1-container">
                    ...
                    <div id="fish-text-container">
                        ...
                        <div id="fish-ribbon-container-4" class="sea-ribbon-container">
                            <div class="sea-ribbon-left"></div>
                            <div class="sea-ribbon-middle">FILE ZILLA</div>
                            <div class="sea-ribbon-right"></div>
                        </div>
                    </div>
            ...
            <div id="ribbon-2-1" class="ribbon-absolute">
                <div class="ribbon-left"></div>
                <div class="ribbon-middle">Web Software</div>
                <div class="ribbon-right"></div>
            </div>

            <div id="ribbon-2-2" class="ribbon-absolute">
                <div class="ribbon-left"></div>
                <div class="ribbon-middle">Scripting Programming Language</div>
                <div class="ribbon-right"></div>
            </div>

            <div id="ribbon-2-3" class="ribbon-absolute">
                <div class="ribbon-left"></div>
                <div class="ribbon-middle">Back End Programming Language</div>
                <div class="ribbon-right"></div>
            </div>
            ...
            <div id="experience-1-container">
                ...
                <div id="experience-text-container-1" class="experience-text-container">
                    <div class="experience-text-a">2014 - 2015</div>
                    <div class="experience-text-b">START</div>
                    <div class="experience-text-d">BẮT ĐẦU HỌC LẬP TRÌNH VÀ GIẢI THUẬT</div>
                </div>
                ...
                <div id="robot">
                    ...
                    <div id="piechart-aol" class="piechart">
                        ...
                        <div id="piechart-aol-text-graphic-1" class="piechart-text-c">C/C++</div>
                        <div id="piechart-aol-text-graphic-2" class="piechart-text-d">80%</div>
                    </div>
                </div>
                ...
                <div class="ribbon-container">
                    <div class="ribbon-relative">
                        <div class="ribbon-left"></div>
                        <div class="ribbon-middle">Infomation</div>
                        <div class="ribbon-right"></div>
                    </div>
                </div>
            </div>
            ...
            <div id="experience-2-container">
                ...
                <div id="experience-text-container-2" class="experience-text-container">
                    <div class="experience-text-a">2015</div>
                    <div class="experience-text-b">GAME DOG EAT MOUSE</div>
                    <div class="experience-text-c">Game Trên Console</div>
                </div>
                ...
                <div id="squid">
                    ...
                    <div id="piechart-incognito" class="piechart">
                        ...
                        <div id="piechart-incognito-text-graphic-1" class="piechart-text-a">CSS</div>
                        <div id="piechart-incognito-text-graphic-2" class="piechart-text-b">15%</div>

                        <div id="piechart-incognito-text-animation-1" class="piechart-text-c">PHP</div>
                        <div id="piechart-incognito-text-animation-2" class="piechart-text-d">70%</div>

                        <div id="piechart-incognito-text-code-1" class="piechart-text-a">MYSQL</div>
            ...
            <div id="experience-3-container">
                ...
                <div id="experience-text-container-3" class="experience-text-container">
                    <div class="experience-text-a">2015 - Now</div>
                    <div class="experience-text-b">STUDY</div>
                    <div class="experience-text-e">C/C++, PHP, HTML/CSS, JS, CI, ....more</div>
                </div>
                ...
                <div id="alien">
                    ...
                    <div id="piechart-foxnews" class="piechart">
                        ...
                        <div id="piechart-foxnews-text-graphic-1" class="piechart-text-c">C/C++</div>
                        <div id="piechart-foxnews-text-graphic-2" class="piechart-text-d">70%</div>

                        <div id="piechart-foxnews-text-animation-1" class="piechart-text-a">CI</div>
                        <div id="piechart-foxnews-text-animation-2" class="piechart-text-b">65%</div>

                        <div id="piechart-foxnews-text-code-1" class="piechart-text-a">LARAVEL</div>
                        <div id="piechart-foxnews-text-code-2" class="piechart-text-b">30%</div>
                    </div>
                </div>
            ...
            <div id="banners-container">
                ...
                <div class="banner">
                    ...
                    <div class="banner-middle-a">
                        <div class="banner-text-a">2016</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">FRONT-END</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">LEARN PHP and MORE</div>
                        <div class="banner-button">
                            <a href="thatweb3.esy.es" target="_blank">
                ...
                <div class="banner">
                    ...
                    <div class="banner-middle-b">
                        <div class="banner-text-a">2016,5</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">CODEIGNITER and MORE</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">LEARN MVC OOP and MORE</div>
                        <div class="banner-button">
                ...
                <div class="banner">
                    <div class="banner-top-a"></div>
                    <div class="banner-middle-a">
                        <div class="banner-text-a">2017</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">LARAVEL</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">HOST AND SECURITY</div>
                        <div class="banner-button">
                            <a href="" target="_blank">
                ...
                <div class="banner">
                    <div class="banner-top-b"></div>
                    <div class="banner-middle-b">
                        <div class="banner-text-a">2011</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">WAPBUILDER</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">WAP CHAT</div>
                        <div class="banner-button">
                            <a href="" target="_blank">
                ...
                <div class="banner">
                    ...
                    <div class="banner-middle-a">
                        <div class="banner-text-a">2011</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">LEARN PASCAL</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">START :)</div>
                    </div>
                    <div class="banner-bottom-a"></div>
                </div>
                ...
                <div class="banner">
                    <div class="banner-top-b"></div>
                    <div class="banner-middle-b">
                        <div class="banner-text-a">2015</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">UIT</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">START :)</div>
                        <div class="banner-button">
                            <a href="" target="_blank">
                ...
                <div class="banner">
                    ...
                    <div class="banner-middle-a">
                        <div class="banner-text-a">2016</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">LEARN HTMLC, CSS, JS</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">GAME ON :)))</div>
                    </div>
                    <div class="banner-bottom-a"></div>
                </div>
                ...
                <div class="banner">
                    <div class="banner-top-b"></div>
                    <div class="banner-middle-b">
                        <div class="banner-text-a">2016-2017</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-b">CI, PHP</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">NO INFOMATION</div>
                        <div class="banner-button">
                            <a href="thatweb.esy.es" target="_blank">
                ...
                <div class="banner">
                    ...
                    <div class="banner-middle-a">
                        ...
                        <div class="banner-text-b">LARAVEL</div>
                        <div class="banner-line"></div>
                        <div class="banner-text-c">UPDATING....</div>
                        <div class="banner-button">
                            <a href="" target="_blank">
        ...
        <div id="contact-container">
            <div id="contact-center">
                ...
                <div id="contact-button">
                    <input type="image" src="<?php echo public_url('cv'); ?>/image/contact-button.png" value="submit" id="send-email"
                           name="send-email"/>
                </div>
            </div>
            ...
            <div id="social-container">
                ...
                <div id="social-middle">
                    <div id="social-facebook" class="social-icon">
                        <a href="http://fb.com/trunghieu.uit" target="_blank">
                            <img src="<?php echo public_url('cv'); ?>/image/social-facebook.png"/>
                        </a>
                    </div>

                    <div id="social-twitter" class="social-icon">
                        <a href="#" target="_blank">
                            <img src="<?php echo public_url('cv'); ?>/image/social-twitter.png"/>
                        </a>
                    </div>

                    <div id="social-dribbble" class="social-icon">
                        <a href="thatweb3.esy.es" target="_blank">
                            <img src="<?php echo public_url('cv'); ?>/image/social-dribbble.png"/>
                        </a>
                    </div>
                </div>
            ...
            <div class="contact-confirmation-container">
                <div class="contact-confirmation">
                    ...
                    <div class="contact-confirmation-text-b">Vui lòng nhập một địa chỉ email hợp lệ!</div>
                </div>
            </div>
            ...
            <div class="contact-confirmation-container">
                <div class="contact-confirmation">
                    ...
                    <div class="contact-confirmation-triangle"></div>
                    <div class="contact-confirmation-title-b">ERROR</div>
                    <div class="contact-confirmation-text-b">Xin vui lòng điền tất cả các thông tin!</div>
                </div>
            </div>
            ...
            <div class="contact-confirmation-container">
                <div class="contact-confirmation">
                    <div class="contact-confirmation-rectangle"></div>
                    <div class="contact-confirmation-triangle"></div>
                    <div class="contact-confirmation-text-d">Đang gửi...</div>
                </div>
            </div>
            ...
            <div class="contact-confirmation-container">
                <div class="contact-confirmation">
                    ...
                    <div class="contact-confirmation-triangle"></div>
                    <div class="contact-confirmation-title-b">ERROR</div>
                    <div class="contact-confirmation-text-c">Có gì đó không đúng. Vui lòng thử lại!</div>
                </div>
            </div>
            ...
            <div class="contact-confirmation-container">
                <div class="contact-confirmation">
                    ...
                    <div class="contact-confirmation-text-a">Tin nhắn của bạn đã được gửi. Tôi sẽ lấy lại cho
...
<script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/email.js"></script>
<script type="text/javascript" src="<?php echo public_url('cv'); ?>/script/main.js"></script>
<div style="text-align:center;clear:both">
    <p>Hỗ trợ trình duyệt: Cốc Cốc, Opera, Chrome, IE8,...</p>
    <p>Liên hệ: <a href="http://fb.com/trunghieu.uit" target="_blank">Hiếu</a></p>
</div>
</body>
</html>