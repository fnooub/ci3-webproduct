...
define('EMAIL_BUSINESS','dotrunghieu7696@gmail.com');//Email Bảo kim
define('MERCHANT_ID','26597');                // Mã website tích hợp
define('SECURE_PASS','7f94553ab479ce1c');   // Mật khẩu

// Cấu hình tài khoản tích hợp
define('API_USER','thatwebesyes');  //API USER
//define('API_PWD','2q1vYc8pJ57bAW9VjCnXH1htk3GOK');       //API PASSWORD
define('API_PWD','xgh9Xv8AZ6qsySxx3cxQ');       //API PASSWORD
